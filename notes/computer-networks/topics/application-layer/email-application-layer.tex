...
% Topic Metadata
% -------------------------------
\newcommand{\TOPICTITLE}{Application Layer: E-mail, SMTP, and IMAP}
...
\begin{enumerate}
    \item What are the three major components of email infrastructure and what is the role of each?
    \item Explain the difference between a mailbox and a message queue in a mail server.
    \item Why do user agents store messages on servers rather than locally?
\end{enumerate}
